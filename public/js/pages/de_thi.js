$(document).ready(function () {
  ...
  // Lấy thời gian kết thúc đề thi (chỉ dùng thoigianketthuc, bỏ giới hạn cá nhân)
  var endTime = -1;
  getTimeTest();
  ...
  // Đã bỏ blur event (chuyển tab) để không tự nộp bài khi mở DevTools hoặc chuyển cửa sổ
});