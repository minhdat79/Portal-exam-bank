...
function showAssignment(data) {
    ...
    data.forEach(element => {
        ...
        <td>
            <a class="fw-semibold">${element['tenchude']}</a>
        </td>
        <td class="text-center col-action">
            <a data-role="phanquyen" data-action="delete" class="btn btn-sm btn-alt-secondary btn-delete-assignment" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete" data-id="${element['manguoidung']}">
...
function showSubject(data) {
    ...
    data.forEach(element => {
        html += `<tr>
        <td class="text-center">
            <input class="form-check-input" type="checkbox" name="selectSubject" value="${element['machude']}">
        </td>
        <td class="text-center">${element['machude']}</td>
        <td>${element['tenchude']}</td>
...
$(document).ready(function(){
    ...
    $(document).on("change", "#giang-vien", function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                subject = new Set(response.map(el => el.machude));
    ...
    $("#list-subject").click(function (e) {
        ...
        const el = e.target;
        const machude = el.value;
        if (el.checked) {
            subject.add(machude);
            el.setAttribute("checked", "checked");
        } else {
            subject.delete(machude);
...
modalAddAssignmentPagination.option.custom.function = "chude";
