  ...
  data.forEach((question) => {
    ...
    html += `<tr>
              ...
              <td class="d-none d-xl-table-cell fs-sm">
                  <a class="fw-semibold">${question["tenchude"]}</a>
              </td>
...
$(document).ready(function () {
  ...
  $.get(
    ...
    function (data) {
      ...
      data.forEach((item) => {
        html += `<option value="${item.machude}">${item.tenchude}</option>`;
      });
      $(".data-chude").html(html);
      $("#main-page-chude").html(html);
    },
    "json"
  );

  $(".data-chude").on("change", function () {
  ...
  $("#main-page-chude").on("change", function () {
    let machude = $(this).val();
    let id = $(this).data("tab");
    let html = "<option></option>";
    $.ajax({
      type: "post",
    ...
    mainPagePagination.option.filter.machude = machude;
