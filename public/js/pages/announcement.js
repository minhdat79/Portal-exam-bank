        ...
        <div class="d-md-flex justify-content-md-between align-items-md-center">
                <div class="p-1 p-md-3">
                    ...
                    <p class="fs-sm text-muted mb-2">
                        <i class="fa fa-layer-group me-1"></i> Gửi cho học phần <strong data-bs-toggle="tooltip" data-bs-animation="true" data-bs-placement="top" style="cursor:pointer" data-bs-original-title="${announce.phong}">${announce.tenchude}</strong>
                    </p>
                </div>
                <div class="p-1 p-md-3">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.forEach((item, index) => {
                    html += `<option value="${index}">${item.machude + " - " + item.tenchude}</option>`;
                });
                $("#phong-hp").html(html);
            }
        });
