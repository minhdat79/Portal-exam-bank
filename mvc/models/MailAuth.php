...
class MailAuth extends DB
{
    ...
    public function __construct()
    {
        ...
        $this->mail->setFrom('tsinh579@gmail.com', 'SDTC TEST');
    }
        ...
        try {
            ...
            $this->mail->Body = '<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                ...
                <div style="border-bottom:1px solid #eee">
                    <a href="#" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">SDTC TEST</a>
                </div>
                ...
                <p style="font-size:0.9em;">Regards,<br />SDTC TEST</p>
                <hr style="border:none;border-top:1px solid #eee" />
                <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
                    <p>QA Inc</p>
                    <p>201/1 Nguyễn Duy Trinh, phường Bình Trưng, TP. HCM</p>
                    <p>Việt Nam</p>
                </div>
                </div>
                </div>';
