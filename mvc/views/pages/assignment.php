    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button data-role="phanquyen" data-action="create" type="button" class="btn btn-hero btn-primary" data-bs-toggle="modal"
                ...
                <div class="mb-4">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-alt" id="search-input" name="search-input"
                            placeholder="Tìm kiếm lãnh đạo phòng, tài liệu...">
            ...
            <div class="modal-body block block-transparent bg-white mb-0 block-rounded">
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="btabs-alt-static-home" role="tabpanel"
                        ...
                        <form class="mb-4 form-phanquyen">
                            <div class="row">
                                <div class="col-6 d-flex flex-row w-100">
                                    ...
                                    <select class="js-select2 form-select data-chude" data-tab="1" id="giang-vien"
                                        name="giang-vien" style="width: 100%;" data-placeholder="Chọn lãnh đạo phòng cần phân công"
                                        required>
                                        <option value=""></option>
                                    </select>
                                </div>
