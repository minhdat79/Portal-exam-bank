        ...
        <div class="row mb-4">
            <div class="col-6 flex-grow-1">
                <div class="input-group">
                    <button class="btn btn btn-alt-primary dropdown-toggle btn-filter" type="button"
                        data-bs-toggle="dropdown" aria-expanded="false">Đang hoạt động</button>
                    <ul class="dropdown-menu mt-1">
                        <li><a class="dropdown-item filter-search" href="javascript:void(0)" data-id="1">Đang hoạt động</a></li>
                        <li><a class="dropdown-item filter-search" href="javascript:void(0)" data-id="0">Đã ẩn</a>
                        </li>
                    </ul>
                    <input type="text" class="form-control" placeholder="Tìm kiếm phòng..." id="form-search-group">
                </div>
            </div>
            <div class="col-6 d-flex align-items-center justify-content-end gap-3">
                <button type="button" class="btn btn-hero btn-primary" data-bs-toggle="modal"
                    data-bs-target="#modal-join-group"><i class="fa fa-fw fa-plus me-1"></i> Tham gia phòng</button>
            </div>
        </div>
    </form>
        ...
        <div class="modal-content">
            <div class="block block-rounded block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Tham gia phòng ban</h3>
                ...
                <div class="block-content">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-alt" name="maphong" id="maphong"
                            placeholder="Nhập mã phòng">
                    </div>
                    <p class="form-text text-muted">Đề nghị Lãnh đạo phòng của bạn cung cấp mã phòng rồi
                        nhập mã đó vào đây.</p>
                    <p class="form-text text-muted">Cách tham gia bằng mã phòng:<br>
                        - Sử dụng tài khoản được phân quyền. <br>
                        - Nhập chính xác mã phòng (ID) của phòng ban đó.
                    </p>
                </div>
                <div class="block-content block-content-full text-end bg-body">
                    <button type="button" class="btn btn-sm btn-alt-secondary" data-bs-dismiss="modal">Đóng</button>
                    <button type="button" class="btn btn-sm btn-primary btn-join-group">Tham gia</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">Nghiệp vụ IBFT 2.0 - SDTC - Phòng 2</h5>
            ...
            <ul class="nav nav-tabs nav-tabs-block nav-justified" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="so-settings-tab" data-bs-toggle="tab"
                        ...
                        <i class="fa fa-fw fa-cog me-2"></i> Bài kiểm tra
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="so-people-tab" data-bs-toggle="tab" data-bs-target="#so-people"
                        ...
                        <i class="far fa-fw fa-user-circle me-2"></i> Thành viên
                    </button>
                </li>
            </ul>
                                ...
                                <div class="d-md-flex justify-content-md-between align-items-md-center">
                                    <div class="p-1 p-md-2">
                                        <h3 class="h4 fw-bold mb-3">
                                            <a href="./test/start/1" class="text-dark link-fx">Kiểm tra định kỳ</a>
                                        </h3>
                                        <p class="fs-sm text-muted mb-0">
                                            <i class="fa fa-clock me-1"></i> Diễn ra từ <span>12:00 08/03/2026</span>
                                            đến
                                            <span>12:00 09/03/2026</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane pull-x fade fade-up" id="so-people" role="tabpanel" aria-labelledby="so-people-tab"
                    ...
                    <div class="block mb-0">
                        <div class="block-content block-content-sm block-content-full bg-body">
                            <span class="text-uppercase fs-sm fw-bold">Thành viên cùng phòng</span>
                        </div>
                        <div class="block-content">
