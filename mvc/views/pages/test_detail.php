            ...
            <div class="block-content tab-content">
                            ...
                            <div class="input-group">
                                <div class="col-md-6 d-flex gap-3">
                                    ...
                                    <ul class="dropdown-menu mt-1" aria-labelledby="dropdown-filter-group">
                                        ...
                                        <?php
                                        foreach ($data["Test"]["phong"] as $phong) {
                                            echo '<li><a class="dropdown-item filtered-by-group" href="javascript:void(0)" data-value="' . $phong['maphong'] . '">' . $phong['tenphong'] . '</a></li>';
                                        }
                                        ?>
                                    </ul>
                ...
                <div class="tab-pane" id="thong-ke" role="tabpanel" aria-labelledby="thong-ke-tab" tabindex="0">
                    ...
                    <ul class="dropdown-menu mt-1" aria-labelledby="dropdown-filter-static">
                        ...
                        <?php
                        foreach ($data["Test"]["phong"] as $index => $phong) {
                            echo '<li><a class="dropdown-item filtered-by-static" href="javascript:void(0)" data-id="' . $phong['maphong'] . '">' . $phong['tenphong'] . '</a></li>';
                        }
                        ?>
                    </ul>
                    <div class="row">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasSetting" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body content-side">
        ...
        <div>
            ...
            <p class="mb-3"><?php echo $data["Test"]["machude"] . " - " . $data["Test"]["tenchude"] ?></p>
            <h5 class="mb-3">GIAO CHO</h5>
            <ul class="nav nav-pills nav-justified push">
                <?php
                foreach ($data["Test"]["phong"] as $phong) {
                    echo '<li class="nav-item me-1 mb-2"><a class="nav-link border text-muted" href="./module/detail/' . $phong['maphong'] . '">' . $phong['tenphong'] . '</a></li>';
                }
                ?>
            </ul>
            <?php
