<div class="content" data-id="<?php echo $data['Detail']['maphong'] ?>">
    <div class="row">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">
                        <?php echo $data['Detail']['machude'] . " - " . $data['Detail']['tenchude'] . " - " . $data['Detail']['tenphong'] ?>
                    </h3>
                    ...
                    <table class="table table-vcenter">
                        <thead>
                            <tr class="table-col-title">
                                ...
                                <th class="text-center col-sort" data-sort-column="id" data-sort-order="default">Mã sinh
                                    viên</th>
