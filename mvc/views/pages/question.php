            ...
            <form action="#" method="POST" id="search-form" onsubmit="return false;">
                <div class="row mb-3">
                    <div class="col-xl-4 d-flex gap-2 align-items-center">
                        <select class="js-select2 form-select" id="main-page-chude" name="main-page-chude"
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <select class="js-select2 form-select data-chude" data-tab="1" id="mon-hoc"
                        ...
                        <form id="form-upload" method="POST" enctype="multipart/form-data">
                            <div class="mb-4">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="" class="form-label">Môn học</label>
                                        <select id="monhocfile" class="js-select2 form-select data-chude" data-tab="2"
