        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-1">
                <form class="form_role">
                    <div class="mb-2">
                        <label class="form-label" for="ten-phong-quyen">Tên nhóm quyền</label>
                        <input type="text" class="form-control form-control-alt" id="ten-phong-quyen"
                            name="ten-phong-quyen" placeholder="VD: Trưởng phòng">
                    </div>
                    <table class="table table-vcenter table-role">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Phòng ban</td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phong" value="view">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phong" value="create">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phong" value="update">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phong" value="delete">
                                </td>
                            </tr>
                            <tr>
                                <td>Câu hỏi</td>
                            ...
                            <tr>
                                <td>Chủ đề</td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="chude" value="view">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="chude" value="create">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="chude" value="update">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="chude" value="delete">
                                </td>
                            </tr>
                            <tr>
                                <td>Phân quyền</td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phanquyen" value="view">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phanquyen" value="create">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phanquyen" value="update">
                                </td>
                                <td class="text-center">
                                    <input class="form-check-input" type="checkbox" name="phanquyen" value="delete">
                                </td>
                            </tr>
                            <tr>
                                <td>Đề thi</td>
                    ...
                    <div class="row justify-content-around">
                        <div class="col-6 form-check form-switch d-flex justify-content-center gap-2">
                            <input class="form-check-input" type="checkbox" value="join" id="join_dethi"
                                name="tgthi">
                            <label class="form-check-label" for="join_dethi">Tham gia bài kiểm tra</label>
                        </div>
                        <div class="col-6 form-check form-switch d-flex justify-content-center gap-2">
                            <input class="form-check-input" type="checkbox" value="join" id="join_hocphan"
                                name="tghocphan">
                            <label class="form-check-label" for="join_hocphan">Tham gia phòng ban</label>
                        </div>
                    </div>
                </form>
            </div>
