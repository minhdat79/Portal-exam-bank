            ...
            <div class="content-header">
                <div class="space-x-1 d-flex align-items-center space-x-2 animated zoomInRight">
                    <a class="link-fx fw-bold" href="home">
                        ...
                        <span class="fs-4 text-dual">SDTC </span><span class="fs-4 text-primary">Test</span>
                    </a>
                </div>
                <div class="space-x-1">
                    ...
                    <div class="js-slider invisible" data-toggle="appear" data-class="animated bounceIn" data-offset="-200" data-timeout="400" data-dots="true" data-arrows="true"
                        ...
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">SDTC Test là một hệ thống tạo đề thi trắc nghiệm rất tiện
                                    lợi và hiệu
                                    quả cho giáo
                        ...
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">Sử dụng nhiều công cụ trong việc dạy học, nhưng SDTC Test là công cụ mình yêu thích
                                    ...
                                    nghiệm tốt nhất cho người dùng. Chúc SDTC Test ngày càng phát triển và nhiều giáo
                                    viên
                                    sẽ biết đến SDTC Test hơn.</p>
                            </blockquote>
                            <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">Ứng dụng SDTC Test có giao diện trực quan, dễ dùng và có đầy đủ các tính năng phục vụ
                                    for dạy và học thời đại 4.0. Ngoài ra ứng dụng luôn được cập nhật và đổi mới từng
                        ...
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">Nhờ có SDTC Test mà tôi đã tiết kiệm được rất nhiều thời gian trong việc quản lý lớp
